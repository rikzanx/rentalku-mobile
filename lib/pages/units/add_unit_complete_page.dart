...
class AddUnitCompletePage extends StatelessWidget {
  const AddUnitCompletePage({Key? key}) : super(key: key);
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 24),
            Text("Unit Rental Telah Ditambahkan", style: AppStyle.title1Text),
            SizedBox(height: 24),
            ElevatedButton(
              onPressed: () {
